...
import { useBleConnectDevice } from "../ble_packet_refactor/hook/useBleConnectDevice";

export type ConnectDeviceSectionRef = {
  runConnectionAction: () => void;
};
...
export const ConnectDeviceSection = forwardRef<ConnectDeviceSectionRef>(
  function ConnectDeviceSection(_, ref) {
    ...
    useImperativeHandle(ref, () => ({
      runConnectionAction: handleConnectionAction,
    }));
